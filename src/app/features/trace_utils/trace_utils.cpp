...
bool trace_filters::FilterProjAim::ShouldHitEntity(IHandleEntity *pServerEntity, int contentsMask)
{
	if (pServerEntity == m_target_ent) {
		return true;
	}
...
TraceType_t trace_filters::FilterProjAim::GetTraceType() const
{
	return TRACE_EVERYTHING;
}