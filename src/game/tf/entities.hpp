...
public:
	CLASSVAR(bool, m_bPredictable, 555);
public:
	bool IsInValidTeam()
	{
...
public:
	...
	NETVAR(float *, m_flPoseParameter, "DT_BaseAnimating");

public:
	//CLASSVAR(CUtlVector<matrix3x4_t>, m_CachedBoneData, 2944);
...
public:
	...
	//NETVAR(CAttributeList, m_AttributeList, "DT_TFWeaponBase"); // + 3512
...
public:
	int GetSlot()
	{
		return mem::callVirtual<331, int>(this); // >>
	}
	...
	void GetSpreadAngle(vec3& out)
	{
		return s::GetSpreadAngles.call<void>(this, out);
	}
	void GetProjectileFireSetup(C_TFWeaponBase* wep, C_TFPlayer* player, Vector src, Vector* ds, QAngle* ang, bool random, float even_more_random)
	{
		return s::GetProjectileFireSetup.call<void>(this, wep, player, src, ds, random, even_more_random);
	}
	...
	{
		return mem::callVirtual<405, bool>(this);
	}
...
class C_TFProjectile_BallOfFire : public C_BaseProjectile
{
public:
